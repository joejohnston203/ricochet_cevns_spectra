...
data = np.loadtxt("daya_bay_bump_ratio.txt", delimiter=",")
...
plt.figure()
plt.plot(x, y, "k-", label="Daya Bay Ratio")
...
plt.ylabel("Ratio to Prediction (Huber+Mueller)")
plt.legend()
plt.savefig("daya_bay_fit.png")
